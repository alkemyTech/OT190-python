...
with DAG(
    dag_id="ETL_Universidad_de_Buenos_Aires",
    ...
    extract_task = PythonOperator(
        ...
        op_kwargs={'file':'Universidad_de_Buenos_Aires'}
    )

    transform_task = PythonOperator(
        task_id='transform_task',
        python_callable=transform,
        op_kwargs={'file':f'universidad_de_buenos_aires'}
    )
    ...
    load_task = PythonOperator(
        ...
        op_kwargs={
            'file_name':f'{path_p}/universidad_de_buenos_aires.txt',
            'key': 'posts.json',
